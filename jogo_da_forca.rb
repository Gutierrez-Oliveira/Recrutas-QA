...
while novo_jogo == "s"
    palavras = %w{fusca jetta corsa astra fusion polo prisma onix amarok siena palio celta kwind argo ranger ecosport scort focus fox bora gol fiesta clio megane lancer i30 hb20 sonata elantra}
